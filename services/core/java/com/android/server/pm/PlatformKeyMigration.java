...
final class PlatformKeyMigration {
    ...
    public static String mapKey(String key) {
        ...
        return replacement != null ? replacement : key;
    }

    public static String mapCert(String cert) {
        // We currently use the same replacement map for everything because they can't possibly
        // conflict, but this is still a separate method for future-proofing.
        return mapKey(cert);
    }
}
